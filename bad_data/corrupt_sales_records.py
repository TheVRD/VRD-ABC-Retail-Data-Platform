...
from bad_data.inject_duplicates import inject_duplicates
from bad_data.inject_invalid_values import inject_invalid_values
from bad_data.inject_nulls import inject_nulls
from bad_data.inject_negative_values import inject_negative_values
from bad_data.inject_wrong_field_value import inject_wrong_field_value
from bad_data.inject_wrong_amount import inject_wrong_amount_value
from config.bad_data_config import ENABLE_DUPLICATES, ENABLE_INVALID_VALUES, ENABLE_NULLS, ENABLE_NEGATIVE_VALUES, ENABLE_WRONG_VALUES, ENABLE_WRONG_AMOUNT
